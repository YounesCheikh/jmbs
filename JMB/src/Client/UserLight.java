...
public class UserLight {
	 ...
	 *            :array of projects
	 */
	public UserLight(String n, String f, String m, int a, String p, ArrayList<Integer> pr) {
		name = n;
		fname = f;
		mail = m;
		accessLevel = a;
	...
	public UserLight(String n, String f, String m, int a, String p, int id, ArrayList<Integer> pr) {
		name = n;
		fname = f;
		mail = m;
		accessLevel = a;
