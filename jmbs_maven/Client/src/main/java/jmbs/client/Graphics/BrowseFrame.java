...
public class BrowseFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3433234610303450965L;
...
class IconCellRenderer extends JLabel implements TreeCellRenderer {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3490608838487716127L;
...
class FileNode {
	...
	public boolean expand(DefaultMutableTreeNode parent) {
		...
		for (int i = 0; i < v.size(); i++) {
			FileNode nd = (FileNode) v.elementAt(i);
			IconData idata = new IconData(BrowseFrame.ICON_FOLDER,
					BrowseFrame.ICON_EXPANDEDFOLDER, nd);
