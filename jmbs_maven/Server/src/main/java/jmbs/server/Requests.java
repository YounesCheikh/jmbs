...
public class Requests extends UnicastRemoteObject implements RemoteRequests {
	...
	public boolean closeProject(int idUser, int idProject) throws RemoteException,SecurityException{
		...
		boolean b = false;
		if (pdao.isOwner(idUser, idProject) || new SecurityDAO(con).isAccessLevelSufficiant(idUser, UserDAO.ADMIN_ACCESS_LEVEL)){
			b = pdao.closeProject(idProject);
		}else throw new SecurityException("You are not autorized to delete this project.");
	...
	/**
         ...
         * @return the User object corresponding to the user or null if wrong pass or email
         * @throws RemoteException
         * @throws SecurityException if connection is not authorised by security manager
         */
	public User connectUser(String em, String psw) throws RemoteException, SecurityException {
         ...
         */
	public Project createProject(String name, int iduser) throws SecurityException{
		ProjectDAO pdao = new ProjectDAO(con);
