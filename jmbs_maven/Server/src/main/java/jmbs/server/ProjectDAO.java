...
public class ProjectDAO extends DAO {
	...
	public Project findProject(int id) {
		...
		try {
			p = new Project(res.getString("name"), res.getInt("idproject"),udao.getUser(res.getInt("idowner")),res.getInt("status"));
	...
	public ArrayList<Project> findProjects(String name){
		...
		try {
			do {
				found.add(new Project(res.getString("name"),res.getInt("idproject"),udao.getUser(res.getInt("idowner")),res.getInt("status")));
			} while (res.next());
		}catch (SQLException e) {
			System.out.println("Unable to find any project with name containg "+name);
		}
